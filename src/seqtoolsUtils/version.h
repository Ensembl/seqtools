 ...
 * -------------------------------------------------------------------
 * This file is part of the SeqTools sequencing tools package, written by
 *	Gemma Barson (Sanger Institute) gb10@sanger.ac.uk
 * This file was copied from the acedb genome database package, writted by
 *      Ed Griffiths (Sanger Institute) edgrif@sanger.ac.uk
 *
