...
static void createBlxColors(BlxViewContext *bc, GtkWidget *widget)
{
  ...
  createBlxColor(bc->defaultColors, BLXCOLOR_MAYBE_CANONICAL, "\"Maybe\" canonical intron bases", "The two bases at the start/end of the intron for the selected MSP are colored this color if they would be canonical if they were on the other strand", BLX_RED, BLX_DARK_GREY, NULL, NULL);
